...
import com.domatix.yevbes.nucleus.core.utils.android.ktx.addTextChangedListenerEx
import com.domatix.yevbes.nucleus.core.utils.android.ktx.postEx
import com.domatix.yevbes.nucleus.core.utils.android.ktx.setOnItemSelectedListenerEx
import com.domatix.yevbes.nucleus.core.utils.android.ktx.subscribeEx
import com.domatix.yevbes.nucleus.databinding.ActivityLoginBinding
    ...
    override fun onPostCreate(savedInstanceState: Bundle?) {
        ...
        binding.spProtocol.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onNothingSelected(p0: AdapterView<*>?) {
                Odoo.protocol = Retrofit2Helper.Companion.Protocol.HTTP
            }

            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {

                Odoo.protocol = when (p2) {
                    0 -> {
        ...
        binding.spProtocol.setSelection(1)
